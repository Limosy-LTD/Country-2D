...
public class GameConttroler : MenuConttroler
{
    ...
    private void Start()
    {
        ...
        {
            ButtonFunctionSettings.SetActive(true);
        }
        else if (BetaFunctionStatus == 0)
        {
            ButtonFunctionSettings.SetActive(false);
        }
    ...
    {
        if (AttackFunction && idCountry != 1 && !UkraineAttack)
        {
            img[0].sprite = fieldCountry[0];
            img[1].sprite = linearCountry[1];
            img[2].sprite = linearCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 1 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
    ...
    {
        if (AttackFunction && idCountry != 2 && !MoldovaAttack)
        {
            img[0].sprite = linearCountry[0];
            img[1].sprite = fieldCountry[1];
            img[2].sprite = linearCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 2 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
    ...
    {
        if (AttackFunction && idCountry != 3 && !RumaniaAttack)
        {
            img[0].sprite = linearCountry[0];
            img[1].sprite = linearCountry[1];
            img[2].sprite = fieldCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 3 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
    ...
    {
        if (AttackFunction && idCountry != 4 && !PolandAttack)
        {
            img[0].sprite = linearCountry[0];
            img[1].sprite = linearCountry[1];
            img[2].sprite = linearCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 4 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
    ...
    {
        if (AttackFunction && idCountry != 5 && !SlovakiaAttack)
        {
            img[0].sprite = linearCountry[0];
            img[1].sprite = linearCountry[1];
            img[2].sprite = linearCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 5 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
    ...
    {
        if (AttackFunction && idCountry != 6 && !HungaryAttack)
        {
            img[0].sprite = linearCountry[0];
            img[1].sprite = linearCountry[1];
            img[2].sprite = linearCountry[2];
        ...
        {
            if (!ActiveHelpMessage && idCountry == 6 && AttackFunction)
            {
                HelpMessageId = 1;
                StartCoroutine(MessageWarning());
            }
